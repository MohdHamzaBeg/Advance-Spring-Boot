...
public class CustomerController {
	...
	public CustomerModel getCustomerById(@PathVariable("customerid") int id) {
	...
	public ResponseEntity updateBeer(@PathVariable("customerid") int id, @RequestBody CustomerModel customer) {
